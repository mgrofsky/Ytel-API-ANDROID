...
public class UsageController extends BaseController {    
    ...
    public void listUsageAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5542268438947499038L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5287803964122133475L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 5091788234663847017L;
            {
